...
def ui():
    with gr.Accordion("Whisper STT", open=True):
        ...
        with gr.Row():
            record_button = gr.Button("Record", elem_id="record-button", elem_classes="custom-button")
            stop_button = gr.Button("Stop", elem_id="stop-button", elem_classes="custom-button")
        with gr.Row():
            with gr.Accordion("Settings", open=False):
                ...
                whipser_language = gr.Dropdown(
                    ...
                    choices=["english", "german"]  # Add more languages as needed
                )
